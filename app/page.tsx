    ...
    <main>
      ...
      <section style={{ ...container, textAlign: "center", padding: "56px 20px 44px" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginTop: 26 }}>
          ...
          <Link
            ...
            style={{ width: "auto", padding: "14px 26px", textDecoration: "none" }}
          >
            Se en ekte profil →
          </Link>
        </div>
      ...
      <section style={{ ...container, padding: "40px 20px 8px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
          {[
            ["📅", "Booking", "Ledige tider beregnes automatisk. Ingen dobbeltbooking."],
            ["💳", "Faktura + Vipps", "Send betalingslenke, bli betalt på sekunder."],
            ["✦", "KI-kundechatbot", "Svarer kunder om priser og tider — døgnet rundt."],
            ["🧾", "Auto skatt-avsetning", "35 % settes til side automatisk. Ingen vårlige overraskelser."],
            ["🛡️", "Verifisert profil", "BankID-verifisert med Vipps. Trygt for kundene."],
            ["🚫", "Ingen lead-avgift", "Flat pris. Vi tar aldri betalt per kunde."],
          ].map(([ic, t, d]) => (
            <div key={t} className="card" style={{ padding: 18 }}>
              <div style={{ fontSize: 22 }}>{ic}</div>
              <h3 style={{ fontFamily: "Georgia, serif", fontSize: 16, margin: "8px 0 4px" }}>{t}</h3>
      ...
      <section style={{ ...container, padding: "44px 20px" }}>
        <div
          className="card"
          style={{ padding: 32, textAlign: "center", maxWidth: 460, margin: "0 auto", borderColor: "var(--accent)" }}
        >
