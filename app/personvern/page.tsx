...
export default function Personvern() {
  return (
    <main className="wrap">
      ...
      <p>Vi bruker underleverandører til drift: hosting og database (Railway), KI-leverandør (Anthropic, for KI-assistenten som svarer på vanlige spørsmål fra dine sluttkunder), betaling og abonnement for deg som bedrift (Vipps, fast avtale), innlogging for deg som bedrift (Vipps Login eller e-post/passord), betaling av faktura for din sluttkunde (Vipps), og e-postleverandør (Brevo), som blant annet sender bookingbekreftelser og påminnelser på e-post. Databehandleravtale inngås med hver av dem.</p>
