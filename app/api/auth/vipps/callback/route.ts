...
export async function GET(req: NextRequest) {
  ...
  // Bruk APP_BASE_URL som redirect-base (req.url er localhost:8080 bak Railways proxy).
  ...
  try {
    ...
    const res = NextResponse.redirect(new URL("/dashboard/koble", origin), { status: 303 });
